...
--
-- Host: localhost
-- Generation Time: Aug 14, 2015 at 06:15 PM
...
--
-- Table structure for table `opt_history`
--
...
CREATE TABLE IF NOT EXISTS `opt_history` (
  ...
  `mode` tinyint(4) NOT NULL COMMENT '0=:mobile,1=:web',
  `create_date` datetime NOT NULL,
  `update_date` datetime DEFAULT NULL,
  `valid_till` datetime NOT NULL,
  `status` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `mobile` varchar(255) NOT NULL COMMENT 'unique contact number',
...
--
-- Constraints for table `opt_history`
--
ALTER TABLE `opt_history`
  ADD CONSTRAINT `opt_history_ibfk_1` FOREIGN KEY (`user`) REFERENCES `users` (`id`);
