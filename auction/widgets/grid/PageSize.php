...
class PageSize extends \yii\base\Widget
{
     ...
     */
    public $sizes = [1 => 1, 5 => 5, 10 => 10,20 => 20,50 => 50, 100 => 100, 200 => 200];
    ...
    public function run()
    {
        ...
        $listHtml = Html::activeDropDownList($this->model,$this->attribute,$this->sizes,$this->options);
